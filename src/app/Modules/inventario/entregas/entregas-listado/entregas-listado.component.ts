...
import { RecepcionActivo } from '../../recepcion-activo/models/RecepcionActivo';
import { RecepcionActivoDetalle } from '../../recepcion-activo/models/RecepcionActivoDetalle';

@Component({
  selector: 'app-entregas-listado',
  templateUrl: './entregas-listado.component.html',
  styleUrls: ['./entregas-listado.component.scss']
})
export class EntregasListadoComponent implements OnInit {
