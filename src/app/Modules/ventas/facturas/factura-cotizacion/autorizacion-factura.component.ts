...
@Component({
  selector: 'app-autorizacion-factura',
  templateUrl: './autorizacion-factura.component.html',
  styleUrls: ['./autorizacion-factura.component.scss']
})
export class AutorizacionFacturaComponent implements OnInit {
