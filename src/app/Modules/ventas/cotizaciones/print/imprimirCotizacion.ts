...
export class ImprimirCotizacion{
    constructor(){}

    construirFactura(cotizacion: Cotizacion,detalleCotizacion: CotizacionDetalle[],compania:Compania){
       ...
       let docDefinition = {
        content: [
          ...
          {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 595-2*40, y2: 5, lineWidth: 3 }]},
          {
            table: {
              ...
              body: [
                ...
                ...detalleCotizacion.map(p => ([p.articulo, p.precio.toFixed(2), p.cantidad.toFixed(2),p.totalDescuento.toFixed(2),p.totalImpuesto.toFixed(2), p.totalNeto.toFixed(2)])),
              ]
            },
            layout: tableLayout,
          },
                ...
                table: {
                  ...
                  body: [
                    [
                      ...
                      {
                        text: cotizacion.subtotal.toFixed(2),
                        alignment: "right",
                        style: "td2"
                      }
                    ],
                    [
                      ...
                      { text: cotizacion.descuentoTotal.toFixed(2), alignment: "right", style: "td2" }
                    ],
                    [
                      { text: "Imp. (18%)", style: ["td2", "strong"] },
                      { text: cotizacion.impuestoTotal.toFixed(2), alignment: "right", style: "td2" }
                    ],
                    [
                      { text: "Total (DOP)", style: ["td2", "strong"] },
                      {
                        text: cotizacion.totalNeto.toFixed(2),
                        alignment: "right",
                        style: ["td2", "strong"]
                      }
                    ]
          ...
          {
            columns: [
              [{ qr: `${cotizacion.nombreCliente}`, fit: '50', alignment: 'center' }],
