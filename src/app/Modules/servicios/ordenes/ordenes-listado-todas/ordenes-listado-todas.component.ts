...
@Component({
  selector: 'app-ordenes-listado-todas',
  templateUrl: './ordenes-listado-todas.component.html',
  styleUrls: ['./ordenes-listado-todas.component.scss']
})
export class OrdenesListadoTodasComponent implements OnInit {
  ...
  getData() {
    ...
    this.httpService.GetAllWithPagination<OrdenListadoViewModel>(DataApi.Recepcion, "GetOrdenesServicioListadoPlanificador", "OrdenID", this.paginaNumeroActual,
