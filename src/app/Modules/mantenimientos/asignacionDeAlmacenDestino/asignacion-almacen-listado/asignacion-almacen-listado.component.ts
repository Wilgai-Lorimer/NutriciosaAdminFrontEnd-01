...
@Component({
  selector: 'app-asignacion-almacen-listado',
  templateUrl: './asignacion-almacen-listado.component.html',
  styleUrls: ['./asignacion-almacen-listado.component.scss']
})
export class AsignacionAlmacenListadoComponent implements OnInit {
